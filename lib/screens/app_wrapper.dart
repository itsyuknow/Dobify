  ...
  Future<void> _snapPinTipToCurrentLocation({
    ...
    try {
      // Wait longer for map controller to be ready and give more time for projection
      await Future.delayed(const Duration(milliseconds: 100));

      // Verify map controller is still available
      ...
      print('Error in _snapPinTipToCurrentLocation: $e');
      // Fallback to simple camera move if the advanced method fails
              ...
              child: GestureDetector(
                onTap: () async {
                  if (_currentPosition != null) {
                    // Use the existing method that properly aligns pin tip with current location
                    await _snapPinTipToCurrentLocation(zoom: 16.0);
                  }
                },
                child: Container(
                  width: 48,
