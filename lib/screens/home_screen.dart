...
class _HomeScreenState extends State<HomeScreen> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin {
  ...
  static const String _devDobPass = '08032002';
  static const String _linkEmail =
      'mailto:yuknow331@gmail.com?subject=Dobify%20App%20–%20Hello%20YuKNOW';
  static const String _linkWhatsApp =
      'https://wa.me/916299419743?text=Hi%20YuKNOW%2C%20I%20saw%20your%20work%20on%20Dobify.';
  static const String _linkInstagram = 'https://instagram.com/itsyuknow';
  static const String _linkLinkedIn = 'https://www.linkedin.com/in/prabhat-dubey-yuknow?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app';
  ...
  void _handleDevTitleTap() {
    final now = DateTime.now().millisecondsSinceEpoch;


    if (_firstTapMs == 0 || now - _firstTapMs > 5000) {
      _firstTapMs = now;
      _devTapCount = 0;
    }
        ...
        return AlertDialog(
          ...
          title: Row(
            children: [
              ...
              const Text('YouKnowMe', style: TextStyle(fontWeight: FontWeight.w800)),
            ],
          ),
          content: TextField(
            controller: ctrl,
            ...
            decoration: const InputDecoration(
              hintText: 'So fill this with love',
              border: OutlineInputBorder(),
            ),
            obscureText: true, // keeps it private on screen
          ),
          actions: [
            TextButton(
                  ...
                  ListView(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          const Expanded(
                            child: Column(
                              ...
                              children: [
                                Text('YuKNOW • Developer',
                                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900)),
                                SizedBox(height: 4),
                                Text('Full-Stack (Flutter, Kotlin, Supabase, Next.js)',
                      ...
                      Wrap(
                        ...
                        runSpacing: 8,
                        children: const [
                          _DevChip(label: 'Flutter'),
                          _DevChip(label: 'Android • Kotlin'),
                          _DevChip(label: 'Supabase (Auth/DB/Storage)'),
                          _DevChip(label: 'Next.js'),
                          _DevChip(label: 'UI/UX & Animations'),
                          _DevChip(label: 'Payments • Invoices'),
                        ],
                      ),

                      const SizedBox(height: 20),

                      // Short app note (kept minimal as requested)
                      _DevAppNote(),
                      ...
                      // Contact actions
                      _DevContactActions(
                        onEmail: () => _launchUrl(_linkEmail),
                        onWhatsApp: () => _launchUrl(_linkWhatsApp),
                        onInstagram: () => _launchUrl(_linkInstagram),
                        onLinkedIn: () => _launchUrl(_linkLinkedIn),
                      ),
...
// ---------- About Me (primary card) ----------
Widget _DevAboutMeCard() {
  return Container(
    ...
    child: const Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        Text(
          'I’m YuKNOW — a self-taught full-stack developer. I designed and built Dobify end-to-end solo, from the Flutter/Kotlin frontends to the Supabase backend and integrations. I care about clean UI, smooth UX, and production-ready engineering.',
          style: TextStyle(color: Colors.black87, height: 1.38),
        ),
        SizedBox(height: 10),
        Text(
          'What I do: product design, mobile apps, secure auth & database models (RLS), payments, invoices, and delightful micro-interactions.',
          style: TextStyle(color: Colors.black87, height: 1.38),
        ),
      ],
    ),
      ...
      children: [
        ...
        const Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('About this App (short)',
                  style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14)),
              SizedBox(height: 4),
              Text(
                'Dobify is a premium on-demand ironing experience with quick pickups, optional 2-hour express, categories, dynamic pricing/coupons, invoices, and notifications — engineered by me.',
...
Widget _DevContactActions({
  ...
  return Column(
    ...
    children: [
      ...
      // show raw info too (useful if deep link blocked)
      Text(
        'WhatsApp: 6299419743  •  Email: yuknow331@gmail.com  •  IG: @itsyuknow',
        style: TextStyle(color: Colors.black.withOpacity(0.65), fontSize: 12.5),
      ),
    ],
  );
}

Widget _actionCircle({required String label, required IconData icon, required VoidCallback onTap}) {
  return GestureDetector(
    onTap: onTap,
    child: Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            shape: BoxShape.circle,
            border: Border.all(color: kPrimaryColor.withOpacity(0.18), width: 2),
            boxShadow: [
              BoxShadow(
                color: Colors.black.withOpacity(0.06),
                blurRadius: 12,
...
class _DevChip extends StatelessWidget {
  final String label;
  const _DevChip({required this.label});
  @override
  Widget build(BuildContext context) {
    return Container(
